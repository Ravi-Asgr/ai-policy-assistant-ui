...
export default function App() {
  ...
  // scrollRef + auto-scroll to bottom when messages or prResponse change
      ...
      <div className="mx-auto flex min-h-[calc(100vh-2rem)] max-w-3xl flex-col">
        ...
        <section className="flex flex-1 flex-col rounded-2xl bg-white shadow-sm">
          ...
          <main
            ...
            style={{ overflowY: "auto", padding: 16, display: "flex", flexDirection: "column", gap: 12, flex: 1, minHeight: 0 }}
          >
            {/* Chat messages first so PR table appears after messages */}
            ...
            {/* Structured PR response rendered after messages so it appears at bottom */}
            {prResponse && <div className="pr-response">{renderPrResponse(prResponse)}</div>}
